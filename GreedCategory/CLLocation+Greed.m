...
@implementation CLLocation (Greed)
...
+ (CLLocationCoordinate2D)gr_marsCoordinateFromBaidu:(CLLocationCoordinate2D)coordinate
{
    double lat = 0.0;
    double lng = 0.0;
    transform_baidu_from_mars(coordinate.latitude, coordinate.longitude, &lat, &lng);
...
+ (CLLocationCoordinate2D)gr_baiduCoordinateFromMars:(CLLocationCoordinate2D)coordinate
{
    double lat = 0.0;
    double lng = 0.0;
    transform_mars_from_baidu(coordinate.latitude, coordinate.longitude, &lat, &lng);
    return CLLocationCoordinate2DMake(lat, lng);
}
